...
namespace GenericRepositoryHelper
{
    // Esta es una clase generica para hacer peticiones a la base de datos por atributos de la clase
    public abstract class RepositoryHelper<T,Context> where T: class where Context : DbContext
    {
        ...
        public async virtual Task<IEnumerable<SqlParameter>> ExecuteSql(object model, ProcedureType procedureType)
        {
            ...
            await _db.Database.ExecuteSqlRawAsync(sqlRawQuery, sqlParameters);
        ...
        public async virtual Task<IEnumerable<SqlParameter>> ExecuteSql(string procedureName = null,List <SqlParameter> sqlParameters=null)
        {
