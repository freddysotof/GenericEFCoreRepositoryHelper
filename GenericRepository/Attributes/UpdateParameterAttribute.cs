...
namespace GenericRepository.Attributes
{
    ...
    // actualizar el registro en la base de datos por medio a un storedprocedure
   ...
   // y el tipo de parametro (ya se input, output o input/output)
    ...
    public class UpdateParameterAttribute : Attribute
    {
        ...
        public UpdateParameterAttribute(SqlDbType dataType)
        {
            this.dataType = dataType;
        }

        public UpdateParameterAttribute(SqlDbType dataType, string databaseName = null, ParameterDirection parameterDirection = ParameterDirection.Input, int size = 0, bool isNullable = false)
        {
        ...
        public UpdateParameterAttribute(SqlDbType dataType, ParameterDirection parameterDirection = ParameterDirection.Input, bool isNullable = false)
        {
            this.parameterDirection = parameterDirection;
            this.dataType = dataType;
            this.isNullable = isNullable;
        }
        public UpdateParameterAttribute(SqlDbType dataType, bool isNullable = false)
        {
            this.dataType = dataType;
            this.isNullable = isNullable;
        }
