...
namespace GenericRepository.Attributes
{
    ...
    // eliminar el registro en la base de datos por medio a un storedprocedure
    ...
    public class DeleteParameterAttribute : Attribute
    {
        ...
        public DeleteParameterAttribute(SqlDbType dataType)
        {
            this.dataType = dataType;
        }
        public DeleteParameterAttribute(SqlDbType dataType, string databaseName = null, ParameterDirection parameterDirection = ParameterDirection.Input, int size =0, bool isNullable = false)
        {
        ...
        public DeleteParameterAttribute(SqlDbType dataType, ParameterDirection parameterDirection = ParameterDirection.Input, bool isNullable = false)
        {
            this.parameterDirection = parameterDirection;
            this.dataType = dataType;
            this.isNullable = isNullable;
        }
        public DeleteParameterAttribute(SqlDbType dataType, bool isNullable = false)
        {
            this.dataType = dataType;
            this.isNullable = isNullable;
        }
