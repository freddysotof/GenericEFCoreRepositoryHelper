...
namespace GenericRepository.Attributes
{
    ...
    public class InsertParameterAttribute : Attribute
    {
        ...
        public InsertParameterAttribute(SqlDbType dataType)
        {
            this.dataType = dataType;
        }
        public InsertParameterAttribute(SqlDbType dataType, string databaseName = null, ParameterDirection parameterDirection = ParameterDirection.Input, int size = 0, bool isNullable = false)
        {
        ...
        public InsertParameterAttribute(SqlDbType dataType, ParameterDirection parameterDirection = ParameterDirection.Input,bool isNullable = false)
        {
            this.parameterDirection = parameterDirection;
            this.dataType = dataType;
            this.isNullable = isNullable;
        }
        public InsertParameterAttribute(SqlDbType dataType, bool isNullable = false)
        {
            this.dataType = dataType;
            this.isNullable = isNullable;
        }
